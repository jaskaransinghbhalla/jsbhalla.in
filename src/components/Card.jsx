...
export default function Card({ data }) {
    return (
        <div className="flex flex-col my-4 lg:mx-8 text-gray-700 bg-white shadow-md bg-clip-border rounded-xl w-72 lg:w-96">
            <div className="h-40 m-2 lg:h-56 overflow-hidden text-white bg-clip rounded-xl bg-blue-gray-500 shadow-blue-gray-500/40">
                <img className="px-2 lg:px-4" src={data.img} alt="card-image" />
            </div>
