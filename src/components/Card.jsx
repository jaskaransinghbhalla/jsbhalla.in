...
export default function Card({ data }) {
    return (<div className="relative flex flex-col mt-6 mx-4 text-gray-700 bg-white shadow-md bg-clip-border rounded-xl w-96">
        <div
            className="relative h-56 mx-4 mt-6 overflow-hidden text-white shadow-lg bg-clip-border rounded-xl bg-blue-gray-500 shadow-blue-gray-500/40">
            <img className="p-4" src={data.img} alt="card-image" />
        </div>
        <div className="p-6">
