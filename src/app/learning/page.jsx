...
function LearningSkills() {
  return (
    <div className="my-6 mx-8 md:mx-32 text-justify">
      ...
      <div className="my-3 ">
        These are the some of the project I plan to build soon for my learning
        purposes....
      </div>
      <div className="ml-8 mr:2  my-3 font-medium ">
        <ol className="list-decimal">
      ...
      <div className="my-3 ">
        These are the some of the computer science domains I wish to explore
        soon....
      </div>
      <div className=" ml-8 mr:2  my-3 font-medium ">
        <ol className="list-decimal">
